package com.wu.lib_base.ft_login;
...
public class LoginPluginConfig {
    ...
    public static final String PACKAGE_NAME = "com.wu.ft_login"; //插件包名
    ...
    public static class PAGE {
        ...
        public static final String PAGE_LOGIN = PACKAGE_NAME + ".view.LoginActivity"; //interface名
