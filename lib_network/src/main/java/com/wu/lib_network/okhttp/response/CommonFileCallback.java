package com.wu.lib_network.okhttp.response;

import android.os.Handler;
import android.os.Looper;
import android.os.Message;

import com.wu.lib_network.okhttp.exception.OkHttpException;
import com.wu.lib_network.okhttp.response.listener.DisposeDataHandle;
import com.wu.lib_network.okhttp.response.listener.DisposeDownloadListener;
...
public class CommonFileCallback implements Callback {
    ...
    public CommonFileCallback(DisposeDataHandle handle) {
        ...
        this.mDeliveryHander = new Handler(Looper.getMainLooper()) {
            @Override
    ...
    private File handleResponse(Response response) {
        ...
        try {
            ...
            while ((length = inputStream.read(buffer)) != -1) {
                ...
                mDeliveryHander.obtainMessage(PROGRESS_MESSAGE, mProgress).sendToTarget();;
            }
            fos.flush();
