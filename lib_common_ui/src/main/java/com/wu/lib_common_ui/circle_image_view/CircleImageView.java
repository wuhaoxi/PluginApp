package com.wu.lib_common_ui.circle_image_view;
...
public class CircleImageView extends ImageView {
    ...
    public void setCircleBackgroundColorResource(@ColorRes int circleBackgoundRes) {
        setCircleBackgroundColor(getContext().getResources().getColor(circleBackgoundRes));
    }
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        try {
            ...
            if (drawable instanceof ColorDrawable) {
                bitmap =
                        Bitmap.createBitmap(COLORDAWABLE_DIMENSION, COLORDAWABLE_DIMENSION, BITMAP_CONFIG);
            } else {
